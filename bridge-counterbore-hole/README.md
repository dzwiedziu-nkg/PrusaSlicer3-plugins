...
So the fill of a region that asked for this keeps only the pieces that reach held-up material at
**both** ends. The stubs go, the hops over the opening go, and the hops that run along the anchor
stay, because there is something underneath them.

-- Print 3 of 4: the same order, every layer, so the run has no boundaries.
-- If this one is clean and print 2 is marked, the marks come from switching the order part way
-- up the part rather than from the order itself. Slice the plain project:
-- prusa_benchy_hullline_test_block4.3mf
--

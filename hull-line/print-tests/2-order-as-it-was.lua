-- Print 2 of 4: the order half on a plain part - the one that came out marked.
-- The wall moves to the end of the layer on the deck layers, which is where the two steps in
-- its cooling rhythm come from. Slice the plain project:
